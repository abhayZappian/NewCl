...
import VerticalDrawer from './Components/drawer.js'
...
const Index = () => {
    ...
    return (
        <>
            <PresetHeader />
            {/* <Header name={"Ask Business Question"} /> */}
            <Box
                sx={{
                    height: '95vh',
                    width: '100%'
            ...
            >
                ...
                >
                    ...
                    <VerticalDrawer defaultValues={{}} isDrawerOpen={isDrawerOpen} setIsDrawerOpen={setIsDrawerOpen} />
                </Box>
