...
import { mdiClockStart, mdiCloseThick } from "@mdi/js";
import "./Style.scss";
import { selectGetNodes } from "store/selectors";
import { useState } from "react";

export const BeginJourneyNode = () => {
      ...
      <div className="NodeWrapper" aria-disabled={true}>
        ...
        >
          <div className="icon_design">
            <Icon path={mdiClockStart} size={1.7} />
          </div>
          <div
            style={{
              position: "absolute",
          ...
          <div className="node_info">
            <div className="NodeTitle">Begin Journey</div>
            <p className="NodeDesc">Begin Journey Related Content</p>
          </div>
        </div>
        <Handle
          type="source"
